...
export default defineNuxtConfig({
  ...
  llms: {
    ...
    description:
      "A modern, full-featured boilerplate for building web applications with Nuxt and Shadcn UI. Features TypeScript, Tailwind CSS, internationalization, form validation, state management, dark mode, and more.",
    sections: [
      {
        title: "Pages",
    ...
    full: {
      title: "Nuxt Shadcn Boilerplate - Complete Documentation",
      description:
        "Comprehensive documentation covering all pages, layout components, UI components, stores, types, utilities, i18n translations, tech stack details, deployment configuration, and project scripts.",
    },
  },
  i18n: {
    defaultLocale: "tr",
